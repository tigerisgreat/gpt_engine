                        ...
                        try:
                            ...
                            while count<if_links_do_not_appear_retry and if_links_appear==False:
                                ...
                                if len(hrefs)==0:
                                    debug()
                                    sb.sleep(2)
                                    # sb.cdp.click('//button[@aria-label="Close sidebar"]')
                                    sb.sleep(2)
                                    # sb.cdp.scroll_down(30000)
                                    sb.sleep(2)     
                                    sb.cdp.click('//button[@class="cursor-pointer absolute"]')
                                    sb.sleep(5)
                                    # sb.cdp.click('//button[@aria-label="Open sidebar"]')
                                    sb.sleep(2)
                                    debug()
                                    ...
                                    # First element
                                    debug()
                                    sb.cdp.click('(//button[@aria-label="Switch model"])[last()]')
                                    ...
                                    debug()
                                    sb.cdp.click_if_visible('div.truncate:contains("Think longer")')
                                    sb.sleep(2)
                                    debug()
                                    sb.cdp.click_if_visible('div.truncate:contains("Search the web")')
                                    debug()
